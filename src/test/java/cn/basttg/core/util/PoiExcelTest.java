...
public abstract class PoiExcelTest {
	...
	public static void main(String[] args){
		// 获取Excel文件的sheet列表
		testGetSheetList("C:/Users/Administrator/Desktop/企业端员工一键导入测试模板.xlsx");
		
		// 获取Excel文件的第1个sheet的内容
//		testReadExcel("C:/Users/Administrator/Desktop/企业端员工一键导入测试模板.xlsx", 0);
		
		// 获取Excel文件的第2个sheet的第2、4-7行和第10行及以后的内容
//		testReadExcel("C:/Users/Administrator/Desktop/企业端员工一键导入测试模板.xlsx", 1, "2,4-7,10-");
		
		// 获取Excel文件的第3个sheet中a,b,g,h,i,j等列的所有内容
//		testReadExcel("C:/Users/Administrator/Desktop/企业端员工一键导入测试模板.xlsx", 2, new String[] {"a","b","g","h","i","j"});
		
		// 获取Excel文件的第4个sheet的第2、4-7行和第10行及以后，a,b,g,h,i,j等列的内容
//		testReadExcel("C:/Users/Administrator/Desktop/企业端员工一键导入测试模板.xlsx", 3, "2,4-7,10-", new String[] {"a","b","g","h","i","j"});
	}
